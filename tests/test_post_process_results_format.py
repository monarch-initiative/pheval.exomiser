...
from pheval_exomiser.post_process.post_process_results_format import (
    extract_disease_results_from_json,
    extract_gene_results_from_json,
    extract_variant_results_from_json,
)

example_exomiser_result = pl.DataFrame(
    [
        {
            "geneSymbol": "PLXNA1",
            "geneIdentifier": {
                            ...
                            "bestModelPhenotypeMatches": [
                                {
                                    ...
                                    "match": {
                                        "id": "MP:0004384",
                                        "label": "small interparietal bone",
                                    },
                                    "lcs": {
                                        "id": "MP:0000438",
                ...
                },
                {
                    ...
                    "frequencyData": {
                        ...
                        "knownFrequencies": [
                            ...
                            {
                                "source": "EXAC_AFRICAN_INC_AFRICAN_AMERICAN",
                                "frequency": 0.19733596,
                            },
...
example_exomiser_result_with_disease = pl.DataFrame(
    [
        {
            "priorityResults": {
                "HIPHIVE_PRIORITY": {
...
class TestExtractGeneResults(unittest.TestCase):

    def test_extract_gene_results(self):
        self.assertTrue(
            extract_gene_results_from_json(example_exomiser_result, "combinedScore").equals(
                pl.DataFrame(
                    [
                        {
                            "gene_symbol": "PLXNA1",
...
class TestExtractVariantResults(unittest.TestCase):

    def test_extract_variant_results(self):
        self.assertTrue(
            extract_variant_results_from_json(example_exomiser_result, "combinedScore").equals(
                pl.DataFrame(
                    [
                        {
                            "chrom": "3",
                            ...
                            "modeOfInheritance": "AUTOSOMAL_DOMINANT",
                            "grouping_id": "b04965e6-a9bb-591f-8f8a-1adcb2c8dc39",
                        },
                        {
                            "chrom": "3",
                            "start": 126730873,
                            ...
                            "score": 0.048419416654489886,
                            "modeOfInheritance": "AUTOSOMAL_RECESSIVE",
                            "grouping_id": "4b166dbe-d99d-5091-abdd-95b83330ed3a",
                        },
                        {
                            "chrom": "3",
                            "start": 126741108,
...
class TestExtractDiseaseResults(unittest.TestCase):
    def test_extract_disease_results(self):
        self.assertTrue(
            extract_disease_results_from_json(example_exomiser_result_with_disease).equals(
                pl.DataFrame(
                    [
                        {"disease_identifier": "ORPHA:25", "score": 0.9175},
                        {"disease_identifier": "OMIM:231670", "score": 0.844},
                    ]
                )
            )
        )
